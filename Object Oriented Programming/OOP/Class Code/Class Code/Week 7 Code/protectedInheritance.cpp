...
//if "access modifier" is protected, then data member of base class; "public becomes protected", "protected remains proected" 
...
int main()
{
		Derived obj1;	
		obj1.dNum = 7;
//		we cannot access "BasePublicNum", beacuse access modefier is protected
//		obj1.BasePublicNum = 0;
//		we can cannot access "BaseProtectedNum", beacuse access modefier is protected, so protected remains proteced
